...
if(isset($_POST['Submit'])){
  ...
  echo "<tr><td>P(KEBUTAAN = X | YA)</td><td> : ".$umur_uji_ya." / ".$row['P_YA']." * ".$diabetes_uji_ya." / ".$row['P_YA']." * ".$hipertensi_uji_ya." / ".$row['P_YA']." * ".$intraokular_uji_ya." / ".$row['P_YA']." * ".$row['P_YA']." / ".$row['P_Kebutaan'];
  ...
  echo "<tr><td>P(KEBUTAAN = X | TIDAK)</td><td> : ".$umur_uji_tidak." / ".$row['P_TIDAK']." * ".$diabetes_uji_tidak." / ".$row['P_TIDAK']." * ".$hipertensi_uji_tidak." / ".$row['P_TIDAK']." * ".$intraokular_uji_tidak." / ".$row['P_TIDAK']." * ".$row['P_TIDAK']." / ".$row['P_Kebutaan'];
  echo " = ".$FormattedNum2."</td></tr>";
  $KEBUTAAN_TIDAK = $FormattedNum2;

  if ($KEBUTAAN_YA > $KEBUTAAN_TIDAK){
    echo "<tr><td colspan=2 >Nilai P(KEBUTAAN = YA ) > P(KEBUTAAN = TIDAK), maka kemungkinana ".$nama_uji." untuk buta lebih besar dengan probabilitas ".$KEBUTAAN_YA."</td></tr>";
    $kebutaan_uji = "YA";
  }
  if ($KEBUTAAN_YA < $KEBUTAAN_TIDAK){
